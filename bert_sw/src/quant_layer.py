...
def pipeline(stage1_args, stage2_args, stage3_args, stage4_args, output_scale):
...
def layer_kernel_gt(layer, hidden_states, attention_mask=None):
    ...
    return stage1_args, stage2_args, stage3_args, stage4_args, output_scale
...
#         hidden_states = layer_kernel_gt(layer_module, hidden_states, attention_mask)
